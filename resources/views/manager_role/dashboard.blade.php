...
<head>
    ...
    <title>DreamHome — Manager Dashboard</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .branch-icon {
            ...
            background: #FBEAF0; border-radius: 10px;
            display: flex; align-items: center; justify-content: center;
            font-size: 18px; color: #72243E; flex-shrink: 0;
        }
        .branch-name {
            font-family: 'DM Serif Display', serif;
            font-size: 16px; color: #4B1528;
        }
        .branch-meta {
            font-size: 11px; color: #993556; margin-top: 2px;
        }
        ...
        .stat-card:hover { box-shadow: 0 2px 10px rgba(75,21,40,0.1); }
        .stat-icon {
        ...
        .stat-icon.rose  { background: #F4C0D1; color: #4B1528; }
        ...
        .nav-card:hover {
            box-shadow: 0 2px 10px rgba(75,21,40,0.1);
            border-color: #993556;
        }
        .nav-card-icon {
            width: 34px; height: 34px; border-radius: 8px;
        ...
        .nav-card-title {
            font-size: 13px; font-weight: 500; color: #4B1528;
        }
        .nav-card-sub {
            font-size: 10px; color: #993556; margin-top: 1px;
        }
        .nav-card-arrow {
            margin-left: auto; color: #C4A8A4; font-size: 16px;
        }
...
<div class="dh-body">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-lbl">Supervisors</div>
            </div>
        </div>
        <div class="stat-card">
            ...
            <div>
                <div class="stat-val">{{ $mgrCount }}</div>
        ...
        <div class="stat-card">
            ...
            <div>
                <div class="stat-val">{{ $secCount }}</div>
                <div class="stat-lbl">Secretaries</div>
            </div>
        </div>
    </div>
    ...
    <div class="nav-grid">
        <a href="{{ route('manager.staff') }}" class="nav-card">
            <div class="nav-card-icon"><i class="ti ti-users"></i></div>
            <div>
                <div class="nav-card-title">Staff List</div>
                <div class="nav-card-sub">View all staff in your branch</div>
            </div>
            <i class="ti ti-chevron-right nav-card-arrow"></i>
        </a>
        <a href="{{ route('manager.supervisors') }}" class="nav-card">
            <div class="nav-card-icon"><i class="ti ti-user-check"></i></div>
            <div>
                <div class="nav-card-title">Supervisors</div>
                <div class="nav-card-sub">View supervisors in your branch</div>
            </div>
            <i class="ti ti-chevron-right nav-card-arrow"></i>
        </a>
        <a href="{{ route('manager.managers') }}" class="nav-card">
            <div class="nav-card-icon"><i class="ti ti-id-badge"></i></div>
            <div>
                <div class="nav-card-title">Managers</div>
                <div class="nav-card-sub">View manager records & compensation</div>
            </div>
            <i class="ti ti-chevron-right nav-card-arrow"></i>
        </a>
        <a href="{{ route('manager.nextofkin') }}" class="nav-card">
            <div class="nav-card-icon"><i class="ti ti-heart"></i></div>
            <div>
                <div class="nav-card-title">Next of Kin</div>
                <div class="nav-card-sub">View staff next-of-kin records</div>
            </div>
            <i class="ti ti-chevron-right nav-card-arrow"></i>
        </a>
    </div>
