...
<div class="dh-body">
    ...
    <div class="branch-banner">
        ...
        <span>
            Showing supervisors for <strong>Branch {{ $branchNo }}</strong> only.
    ...
    <div class="stat-row">
        ...
        <div>
            ...
            <div class="stat-lbl">Supervisors in Your Branch</div>
        </div>
    </div>
    ...
    <div class="search-row">
        <div class="search-wrap">
            ...
            <input class="search-input" type="text"
                   placeholder="Search supervisor, staff ID…"
            ...
            <table>
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-branch">{{ $sup->staff->branch_no ?? '—' }}</span>
                        </td>
                        <td>
    ...
    <div class="confirm-bar">
        ...
        <span>
            <strong>Supervisor</strong> is a subtype of Staff —
            each record links to a Staff entry via <strong>staff_id</strong>.
        </span>
    </div>
