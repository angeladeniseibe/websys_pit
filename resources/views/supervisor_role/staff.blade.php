...
<head>
    ...
    <title>DreamHome — My Staff</title>
...
<div class="dh-hero">
    ...
    <div class="dh-page-title">My Staff</div>
    <div class="dh-page-sub">
        <i class="ti ti-users" style="font-size:13px;"></i>
        Supervisor {{ $staffId }} · Your assigned group
    </div>
</div>
...
<div class="dh-body">
    ...
    <div class="branch-banner">
        ...
        <span>
            Showing only staff assigned to <strong>your supervision ({{ $staffId }})</strong>.
    ...
    <div class="stat-row">
        ...
        <div>
            ...
            <div class="stat-lbl">Staff in Your Group</div>
        </div>
    </div>
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="empty-state">
                                ...
                                <p>No staff assigned to your supervision yet.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
