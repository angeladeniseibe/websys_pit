...
<head>
    ...
    <title>DreamHome — Supervisor Dashboard</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .branch-icon {
            width: 40px; height: 40px; background: #FBEAF0; border-radius: 10px;
        ...
        .stat-card {
            background: #fff; border: 0.5px solid #E8D0CE; border-radius: 10px;
...
<div class="dh-hero">
    ...
    <div class="dh-page-sub">
        ...
        Supervisor Dashboard · Read-only access
    </div>

    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px;position:relative;z-index:1;">
        <span class="role-badge">
            <i class="ti ti-user-check" style="font-size:11px;"></i> Supervisor
        </span>
        <span class="role-badge">
...
<div class="dh-body">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-icon pink"><i class="ti ti-users"></i></div>
            <div>
                <div class="stat-val">{{ $staffCount }}</div>
                <div class="stat-lbl">My Staff</div>
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-icon rose"><i class="ti ti-user-check"></i></div>
            <div>
        ...
        <div class="stat-card">
            <div class="stat-icon blue"><i class="ti ti-keyboard"></i></div>
            <div>
    ...
    <div class="nav-grid">
        <a href="{{ route('supervisor.staff') }}" class="nav-card">
            <div class="nav-card-icon"><i class="ti ti-users"></i></div>
            <div>
                <div class="nav-card-title">My Staff</div>
                <div class="nav-card-sub">View your assigned group of staff</div>
            </div>
            <i class="ti ti-chevron-right nav-card-arrow"></i>
        </a>
        <a href="{{ route('supervisor.supervisors') }}" class="nav-card">
            <div class="nav-card-icon"><i class="ti ti-user-check"></i></div>
            <div>
                <div class="nav-card-title">Supervisors</div>
                <div class="nav-card-sub">View all supervisors in your branch</div>
            </div>
            <i class="ti ti-chevron-right nav-card-arrow"></i>
        </a>
    </div>
