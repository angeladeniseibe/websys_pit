    ...
    <div class="bg-white border-2 border-gray-900 rounded-2xl shadow-lg overflow-hidden">
        ...
        <table class="min-w-full text-sm">
            ...
            <thead class="bg-gray-100 border-b-2 border-gray-900">
                <tr>
                    <th class="px-6 py-5 text-left font-bold">Client's Name</th>
                    <th class="px-6 py-5 text-left font-bold">Property</th>
                    <th class="px-6 py-5 text-left font-bold">Start Date</th>
                    <th class="px-6 py-5 text-left font-bold">End Date</th>
                </tr>
            </thead>
            ...
            <tbody class="divide-y-2 divide-gray-900">
                ...
                @forelse($leases as $lease)
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-5 font-semibold text-gray-900">{{ $lease->tenant_name }}</td>
                        <td class="px-6 py-5 text-gray-800 font-medium">{{ $lease->property_id }}</td>
                        <td class="px-6 py-5 text-gray-700">{{ $lease->start_date }}</td>
                        <td class="px-6 py-5 text-gray-700">{{ $lease->end_date }}</td>
                    </tr>
                @empty
                    <tr>
