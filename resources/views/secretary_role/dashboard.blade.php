...
<head>
    ...
    <title>DreamHome — Secretary Dashboard</title>
...
<div class="dh-body">
    ...
    <div class="info-note">
        ...
        <span>
            You have <strong>read-only</strong> access as a Secretary.
            You can view your branch info and your own profile.
            Contact your supervisor or manager for changes.
        </span>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div>
                <div class="stat-val">{{ $secretary->typing_speed ?? '—' }}</div>
                <div class="stat-lbl">Typing Speed (WPM)</div>
            </div>
        </div>
    </div>
    ...
    <div class="nav-grid">
        <a href="{{ route('secretary.profile') }}" class="nav-card">
